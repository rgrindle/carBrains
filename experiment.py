...
def get_image_matrix(directory, start, end):
    ...
    matrix = np.zeros((len(image_filepaths), 28, 28))
...
train_X = get_image_matrix(input_directory, 1, 200)
train_Y = get_label_matrix(1, 200)
...
test_X = get_image_matrix(input_directory, 1, 20)
test_Y = get_label_matrix(1, 20)
